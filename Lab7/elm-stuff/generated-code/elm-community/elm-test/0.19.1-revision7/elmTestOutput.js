...
var $author$project$Documentation$combinations = function (l) {
	var combinationsN = F2(
		function (n, lx) {
			var _v0 = _Utils_Tuple2(n, lx);
			_v0$0:
			while (true) {
				if (!_v0.b.b) {
					if (!_v0.a) {
...
var $author$project$VerifyExamples$Documentation$Combinations0$spec0 = A2(
	$elm_explorations$test$Test$test,
	'#combinations: \n\n    combinations [1, 2, 3]\n    --> [[1,2,3],[1,2],[1,3],[1],[2,3],[2],[3],[]]',
	function (_v0) {
		return A2(
			$elm_explorations$test$Expect$equal,
			$author$project$Documentation$combinations(
				_List_fromArray(
					[1, 2, 3])),
			_List_fromArray(
				[
...
var $author$project$Documentation$tails = function (l) {
	if (!l.b) {
		return _List_fromArray(
			[_List_Nil]);
	} else {
		...
		return A2(
			$elm$core$List$cons,
			A2($elm$core$List$cons, x, xs),
			$author$project$Documentation$tails(xs));
	}
};
var $author$project$VerifyExamples$Documentation$Tails0$spec0 = A2(
	$elm_explorations$test$Test$test,
	'#tails: \n\n    tails [1, 2, 3]\n    --> [[1, 2, 3], [2, 3], [3], []]',
	function (_v0) {
		return A2(
			$elm_explorations$test$Expect$equal,
			$author$project$Documentation$tails(
				_List_fromArray(
					[1, 2, 3])),
			_List_fromArray(
				[
...
var $author$project$VerifyExamples$Documentation$Combinations1$spec1 = A2(
	$elm_explorations$test$Test$test,
	'#combinations: \n\n    combinations [1, 2]\n    --> [[1, 2], [1], [2], []]',
	function (_v0) {
		return A2(
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['D:\\teaching\\2021_2022\\fp\\L07\\tests\\VerifyExamples\\Documentation\\Combinations0.elm', 'D:\\teaching\\2021_2022\\fp\\L07\\tests\\VerifyExamples\\Documentation\\Combinations1.elm', 'D:\\teaching\\2021_2022\\fp\\L07\\tests\\VerifyExamples\\Documentation\\Tails0.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 160927656945581
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Documentation$Combinations0$spec0)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Documentation.Combinations1',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Documentation$Combinations1$spec1)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Documentation.Tails0',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Documentation$Tails0$spec0)
				]))
		]));
_Platform_export({'Test':{'Generated':{'Main':{'init':$author$project$Test$Generated$Main$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-9912-1";
var net = require('net'),
